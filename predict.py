...
def main():
    ...
    predict_command = " ".join(
        [
            env_variables_str,
            f"{py_exec} -m commaqa.inference.configurable_inference",
    ...
    if not args.skip_evaluation:
        ...
        evaluate_command = " ".join([f"{py_exec} evaluate.py", str(config_filepath), str(args.evaluation_path)]).strip()
        ...
        evaluate_command = " ".join(
            [f"{py_exec} evaluate.py", str(config_filepath), str(args.evaluation_path), "--official"]
        ).strip()
